...
class MetaSGD(optim.SGD):
    def __init__(self, params, modules, lr=0.1, momentum=0, weight_decay=0, nesterov=False, rollback=False, cpu=False):
        super(MetaSGD, self).__init__(params, lr, momentum=momentum, weight_decay=weight_decay, nesterov=nesterov)
        self.prev_states = []
