    ...
    """`CUB-200-2011 <http://www.vision.caltech.edu/visipedia/CUB-200-2011.html>`_ Dataset.
        Args:
            ...
            download (bool, optional): If true, downloads the dataset from the internet and
               ...
               downloaded again.
    """
    base_folder = '/home/zhl/dataset/cub_200_2011/CUB_200_2011/images'
...
class Cub2011Sample(VisionDataset):
    """`CUB-200-2011 <http://www.vision.caltech.edu/visipedia/CUB-200-2011.html>`_ Dataset.
        Args:
            root (string): Root directory of the dataset.
            train (bool, optional): If True, creates dataset from training set, otherwise
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False, k=4096):
        super(Cub2011Sample, self).__init__(root, transform=transform, target_transform=target_transform)
